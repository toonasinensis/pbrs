...
class HumanoidCfg(LeggedRobotCfg):
    ...
    class control(LeggedRobotCfg.control):
        ...
        stiffness = {'Waist': 30.0, 'Shoulder_Z': 30, 'Shoulder_X': 30, 'Shoulder_Y': 30, 'Elbow': 30,
                     'Hip_Z': 30, 'Hip_X': 30, 'Hip_Y': 30, 'Knee': 30, 'Ankle_Y': 30, 'Ankle_X': 30
                     }  # [N*m/rad]
        # orgin PD of ankle: P: 'Ankle_Y': 50, 'Ankle_X': 50; D:'Ankle_Y': 0.5, 'Ankle_X': 0.3
        damping = {'Waist': 5., 'Shoulder_Z': 5, 'Shoulder_X': 5, 'Shoulder_Y': 5, 'Elbow': 5,
                   'Hip_Z': 5, 'Hip_X': 5, 'Hip_Y': 5, 'Knee': 5, 'Ankle_Y': 5, 'Ankle_X': 5
                   }  # [N*m*s/rad]     # [N*m*s/rad]
        # action scale: target angle = actionScale * action + defaultAngle
        # action_scale = 1.0
        action_scale = {'Waist': 1.0, 'Shoulder_Z': 1.0, 'Shoulder_X': 1.0, 'Shoulder_Y': 1.0, 'Elbow': 1.0,
                        'Hip_Z': 1.0, 'Hip_X': 1.0, 'Hip_Y': 1.0, 'Knee': 1.0, 'Ankle_Y': 1.0, 'Ankle_X': 1.0}
    ...
    class asset(LeggedRobotCfg.asset):
        ...
        #     'right_hand',
        # ]
        terminate_after_contacts_on = ['SACRUM', 'UPPERARM', 'ILIUM', 'ISCHIUM', 'THIGH']
